...
"  bloom implementation, Tiled integration, drawing optimization code, assorted bugfixes, integrated end game art",
...
"  conversation tweaks, obtainable and interactive item implementation, character motion fixes, NPC movement implementation, obtainable items improvements, accusation code,",
"  integration of Fusion alley dealer and Jen story gameplay events, additional NPC placement, dialog bug fix, Alex integration, mouth setup for Fusion/Alex/Jen, game end text",
...
"  ambient city noise, volume mixing, song integration, additional bug fixes, inventory sounds, item pickup sound",
...
"  sprite, fusion character portrait, opening story, Alex portrait and sprite animations, cop portrait badge, touch ups to match sprites and portraits of Dan and Cop",
...
"Jaime Rivas - Wall collision code, cat character sprite, additional voxel drafts",
...
"Chris Markle - End Scene/Credits roll song, Main Menu song, song played on winning the game, mechanical grinding sounds",
"Charlene A. - Julie portrait with emotion frames, Julie sprite animations",
...
"Cecilia Borges - City song played after the crime scene is visited",
"Shaun Lindsley - Synthwave song, busy street sounds",
"Kirvee - Walking speed adjustments, text editing, help with internal QA testing",
"Terrence McDonnell - Collision debugging visualization, police portrait import",
