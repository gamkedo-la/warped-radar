...
"  bloom implementation, assorted bugfixes",
"H Trayford - Dialog editor (development authoring tool), dialog transition arrows, tile and object culling render optimizations, character-to-character collisions, depth sorting",
"  implementation, enter/exit room functionality, character integration (Rose, Julie, Uncle Dave, NPC Agent, Cat Man, Cop), event manager, conversation tweaks, family photo code,",
"  character motion fixes, NPC movement implementation, obtainable items improvements, accusation functionality",
...
"Jeff \"Axphin\" Hanlon - Character designer template, John directional animations, Rose directional animations, speed tuning, welcome sign, Dave sprite improvements, cat portrait",
"  sprite, fusion character portrait",
...
"Michelly Oliveira - Dialog starts when near character, pause when clicked away, in-game labels implementation, help screen",
