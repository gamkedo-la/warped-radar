let levelEditor = new(function () {
    ...
    let levelCol = 0;
    let levelRow = 0;
    let defaultSet = [TILE_GROUND, TILE_WALL, TILE_BROKEN_SKATEBOARD, TILE_BURNER_PHONE, TILE_CROWBAR, TILE_HOODIE, TILE_MEDICAL_NOTEBOOK, TILE_SEALED_TUBE, TILE_THUMB_DRIVE, TILE_TRAIN_TICKET]; //will switch out for different tiles later
    let tileSets = {
